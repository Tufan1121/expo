...
public class ver_pedidos_hechosibodegascotiza extends AppCompatActivity implements View.OnClickListener {
Button pedidobuscar;
//Button salirpedidos;
    ...
    String GET = appRutaservidor.IP  + "/obtener_cotiza.php";
    String GET_BY_ID = appRutaservidor.IP  + "/obt_cotiza.php";
    String GET_BY_ID2 = appRutaservidor.IP  + "/obt_cotizaName.php";
        ...
        txtbuscapepdido.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(txtbuscapepdido.getText().toString().trim().equalsIgnoreCase("")){
                    ...
                    Toast.makeText(ver_pedidos_hechosibodegascotiza.this, "Coloca tu pedido",Toast.LENGTH_LONG).show();

                }else if(optbuscar.getSelectedItem().toString().trim().equalsIgnoreCase("Busca Pedido por:")){
                    optbuscar.setFocusable(true);
                    Toast.makeText(ver_pedidos_hechosibodegascotiza.this, "Selecciona como quieres buscar tu pedido",Toast.LENGTH_LONG).show();
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                listatodoslospedidos.setAdapter(new Adaptadorpedidos(ver_pedidos_hechosibodegascotiza.this,enpedido,enfecha,ennombre,entotalcompra));
                ...
                listatodoslospedidos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        listaConta.pedidoverpdf=listapedidosnoserie.get(position);
                            Intent pasaaverdetalledepedido = new Intent(ver_pedidos_hechosibodegascotiza.this,verpedf2ibodegas.class);
