...
public class apedido2ibodegascotiza extends AppCompatActivity {
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s=="No"){
                ...
                lista_x_tapete.setAdapter(new Adaptador_x_nombreIbodegas(apedido2ibodegascotiza.this,listaxclave,listaxnombre,listaxmedidas,listaxstok,listaximg,listadiseno,listabodega1,listabodega2,listabodega3,listabodega4,xlistaprecio1,xlistaprecio2,xlistaprecio3));


                lista_x_tapete.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Toast.makeText(apedido2ibodegascotiza.this,"estas es la clave "+listaxclave.get(position),Toast.LENGTH_SHORT).show();
                        //listatapetescotiza.clavemanualcotiza.setText(listaxclave.get(position));
