...
public class generaPedido extends AppCompatActivity implements View.OnClickListener{
        ...
        if(finaliza==0) {
            ...
            dialogo.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogo1, int id) {
                    //codigo
                    Intent regresaalista = new Intent(generaPedido.this, listatapetes.class);
    ...
    ObtenerWebService8 hiloconexion8;
    String entrega;
    ...
    String buscarcorreoCliente = appRutaservidor.IP  + "/getclient.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_genera_pedido);
        //llenaarray();
        ...
        finaliza=0;//para saber si guardo el pedido o no.....
        ...
        salirpedido.setOnClickListener(this);
        ...
        switch (v.getId()){
            ...
            case R.id.btn_GP_guardar:
                ...
                if(observaciones.getText().toString().trim().equalsIgnoreCase("")){
                    ...
                    Toast.makeText(generaPedido.this, "Selecciona Metodo de pago",Toast.LENGTH_SHORT).show();
                    metodopago.setFocusable(true);
                    metodopago.setFocusable(true);
                    metodopago.setFocusableInTouchMode(true);
                    metodopago.requestFocus();
                }else if(cuanto_anticipo.getText().toString().trim().equalsIgnoreCase("0")) {
                    cuanto_anticipo.requestFocus();
                    Toast.makeText(generaPedido.this, "Coloca el pago total o anticipo", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(generaPedido.this, "Coloca la cantidad del otro metodo de  pago ", Toast.LENGTH_LONG).show();
                    ...
                    while(i<numeroLista){
                        ...
                        //hilo.executeOnExecutor(UPDATE,"4",claveconsulta,actializastok)
                                /*
                                //aqui hacemos consulta de los tapetes que van a ir en el pedido
                                claveconsulta=lista.get(i).toString();
                                //String claveconsulta=clavetapete.getText().toString();
                                ...
                                stocksentero=Integer.parseInt(sttok);
*/
                                /*if (stocksentero==0){
                                    //NO TE VA A REGISTRAR MANO DE LOS MANOS
                                }else{*/
                        //SI HAY ESXISTENCIAS LO VA A INSERTAR EN BASE DE DATOS DETALLE
                        //CONSULTA DE ID PARA EL DETALLEPEDIDO AJA AJA *********************
                        //sacarconsecutivodedetallepedido();
                        //String pp=Integer.toString(numerodetallepedido);
                    ...
                    lWhatsapp.setVisibility(View.INVISIBLE);

                    //pagartotalP.setVisibility(View.INVISIBLE);

                    //*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
                    msg.setVisibility(View.VISIBLE);

                    Intent verpdfterminado= new Intent(this, verpedf2.class);
                    startActivity(verpdfterminado);
                    //msg.setText("preciona el boton cerrar");
...
//*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
    ...
    protected void onRestart() {
        super.onRestart();
        msg.setText("Generado ya puede cerrar");
    }
...
//BUSCA CONSECUTIVO DE PEDIDO Y GENERA EL NOMBRE O NUMERO DE PEDIDO....
    public class ObtenerWebService3 extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            //numeroPedido.setText(listaConta.encabrzadopedido+numeropedido+"E"+listaConta.idusuariotufan);
            numeroPedido.setText(listaConta.encabrzadopedido+"-"+numeropedido+listaConta.idusuariotufan+"E");

            //numeroPedido.setText(numeropedido+listaConta.encabrzadopedido+"-"+"E"+listaConta.idusuariotufan);
            pedidoserie=numeroPedido.getText().toString();
            lWhatsapp.setText(listaConta.WhatsApp);
        }
        ...
        protected String doInBackground(String... params) {
            ...
            if(params[1].equals("4")){    // update
                ...
                try {
                    ...
                    JSONObject jsonParam = new JSONObject();
                    jsonParam.put("tabla",params[2]);
                    jsonParam.put("producto1",params[3]);
                    jsonParam.put("hm", params[4]);
...
//////Prueba de correo, no sirve

    private void envcorreo(){
        enviacorreo1 objCorreo=new enviacorreo1();
    }
    ...
    private void EnviarCorreo(String valorenvio) {
        ...
        //String sCorreo = sCorreo.getText().toString().trim();
        //String sAsunto = sAsunto.getText().toString().trim();
        //String sMensaje = sMensaje.getText().toString().trim();
        ...
        clsEnviaCorreo objCorreo = new clsEnviaCorreo(generaPedido.this, sCorreo, sAsunto, sMensaje);
        objCorreo.execute();
    }
