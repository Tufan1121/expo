...
public class ver_pedidos_hechos_modificarE extends AppCompatActivity implements View.OnClickListener {
    Button pedidobuscar;
...
//+9+9+9+9+9+9+9+9+9+9+9+9++9+9
        ...
        txtbuscapepdido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ver_pedidos_hechos_modificarE.this, android.R.layout.simple_list_item_1,listItems);
        ...
        txtbuscapepdido.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(txtbuscapepdido.getText().toString().trim().equalsIgnoreCase("")){
                    ...
                    Toast.makeText(ver_pedidos_hechos_modificarE.this, "Coloca tu pedido",Toast.LENGTH_LONG).show();

                }else if(optbuscar.getSelectedItem().toString().trim().equalsIgnoreCase("Busca Pedido por:")){
                    optbuscar.setFocusable(true);
                    Toast.makeText(ver_pedidos_hechos_modificarE.this, "Selecciona como quieres buscar tu pedido",Toast.LENGTH_LONG).show();
                    ...
                    if(optbuscar.getSelectedItem().toString().trim().equalsIgnoreCase("Nombre")){
                        ...
                        //Toast.makeText(this,"por ulti mos 4 digitos.",Toast.LENGTH_SHORT).show();
                        enpedido.clear();
                        enfecha.clear();
                        ennombre.clear();
                        entotalcompra.clear();
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                listatodoslospedidos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent pasarAupdate= new Intent(ver_pedidos_hechos_modificarE.this,pedidoestatusupdate2.class);
                        pasarAupdate.putExtra("pedido",listapedidosnoserie.get(position));
                        startActivity(pasarAupdate);
                    }
                });
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                listatodoslospedidos.setAdapter(new Adaptadorpedidos(ver_pedidos_hechos_modificarE.this,enpedido,enfecha,ennombre,entotalcompra));
                ...
                listatodoslospedidos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent pasaaverdetalledepedido = new Intent(ver_pedidos_hechos_modificarE.this,verpedf2ibodegas.class);
