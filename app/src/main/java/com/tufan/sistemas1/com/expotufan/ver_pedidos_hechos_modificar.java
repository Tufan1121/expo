...
public class ver_pedidos_hechos_modificar extends AppCompatActivity implements View.OnClickListener {
    Button pedidobuscar;
        ...
        txtbuscapepdido.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(txtbuscapepdido.getText().toString().trim().equalsIgnoreCase("")){
                    ...
                    Toast.makeText(ver_pedidos_hechos_modificar.this, "Coloca tu pedido",Toast.LENGTH_LONG).show();

                }else if(optbuscar.getSelectedItem().toString().trim().equalsIgnoreCase("Busca Pedido por:")){
                    optbuscar.setFocusable(true);
                    Toast.makeText(ver_pedidos_hechos_modificar.this, "Selecciona como quieres buscar tu pedido",Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                listatodoslospedidos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    Intent pasarAupdate= new Intent(ver_pedidos_hechos_modificar.this,pedidoestatusupdate.class);
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                listatodoslospedidos.setAdapter(new Adaptadorpedidos(ver_pedidos_hechos_modificar.this,enpedido,enfecha,ennombre,entotalcompra));
                ...
                listatodoslospedidos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent pasaaverdetalledepedido = new Intent(ver_pedidos_hechos_modificar.this,verpedf2ibodegas.class);
