...
public class entrega_estatus_pedido extends AppCompatActivity implements View.OnClickListener {
    Button pedidobuscar;
    Button salirpedidos;
    ...
    String GET = appRutaservidor.IP  + "/obtener_pedidos_allexpo.php";
    String GET_BY_ID = appRutaservidor.IP  + "/obtener_pedido_idpexpo.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_entrega_estatus_pedido_foraneo);
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(entrega_estatus_pedido.this, android.R.layout.simple_list_item_1,listItems);
