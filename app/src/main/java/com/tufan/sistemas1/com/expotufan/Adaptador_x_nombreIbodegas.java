...
public class Adaptador_x_nombreIbodegas extends BaseAdapter{
...
//precio lista
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final TextView bg4=(TextView)vista1.findViewById(R.id.nBodega4);
