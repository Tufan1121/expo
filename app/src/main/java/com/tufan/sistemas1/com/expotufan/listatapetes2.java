...
public class listatapetes2 extends AppCompatActivity{
TextView txtpasa;
...
private  int total=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listatapete2);
        ...
        if(listaConta.clavetapete==null){
            ...
            mlista.setAdapter(new Adaptador2(listatapetes2.this,listaConta.clavetapete,listaConta.descripciontapete,listaConta.precioXtapete,listaConta.precioXtapeteEx,listaConta.precioXtapeteMa,listaConta.medidastapete,listaConta.porciento));
        ...
        clavemanual.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
                ...
                if(clavemanual.toString().trim().equalsIgnoreCase("")){
                    Toast.makeText(listatapetes2.this,"Coloca Clave ",Toast.LENGTH_LONG).show();
                    ...
                    if (validastock.error404==0){
                        Toast.makeText(listatapetes2.this, "No esta se encuantra en tu inventario",Toast.LENGTH_LONG).show();
                    }else{
                        ...
                        if(validarsihay<=0){
                            Toast.makeText(listatapetes2.this,"No tienes existencias... ",Toast.LENGTH_LONG).show();

                        }else{

                            claveconsulta=claveconsulta.toUpperCase();
                            if(checarlista==0){
                                hiloconexion2 = new listatapetes2.ObtenerWebService();
                                ...
                                if (x==1){
                                    ...
                                    Toast.makeText(listatapetes2.this,"ya esta en tu lista... indica cuantas requieres",Toast.LENGTH_LONG).show();
                        ...
                        if(validarsihay<=0){
                            ...
                            if(checarlista==0){
                                ...
                                if (x==1){
                                    ...
                                    Toast.makeText(listatapetes2.this,"ya esta en tu lista... una mas",Toast.LENGTH_LONG).show();
...
//*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*--*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*
        ...
        hacerpedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(listaConta.clavetapete.size()==0){
                    Toast.makeText(listatapetes2.this,"no hay tapetes",Toast.LENGTH_LONG).show();

                }else {
                    Intent intent = new Intent(listatapetes2.this, generaPedido2.class);
        ...
        invbodegas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent inventariobodegas= new Intent(listatapetes2.this,apedido2ibodegas.class);
...
//***********************************************************************************************************************************************************************************
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s=="No"){
                Toast.makeText(listatapetes2.this,"no se escuentra en expo",Toast.LENGTH_LONG).show();
