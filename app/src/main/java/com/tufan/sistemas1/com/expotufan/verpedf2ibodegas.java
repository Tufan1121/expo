...
public class verpedf2ibodegas extends AppCompatActivity {

String pedidoverurl;
//String enviarpedidocorreo;
    ObtenerWebService hiloconexion;
    String GET2 = appRutaservidor.IP  + "/pedidoibodegas.php";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_verpedf2ibodegas);
        pedidoverurl=listaConta.pedidoverpdf;

        //pedidoverurl=(String) getIntent().getSerializableExtra("pedido");
        Intent intent = new Intent();
        intent.setDataAndType(Uri.parse(appRutaservidor.IP+"/pedidoibodegas.php?pedido="+pedidoverurl), "application/pdf");
        startActivity(intent);

        hiloconexion = new ObtenerWebService();
        hiloconexion.execute(GET2+"?pedidoibodegas="+pedidoverurl,"1");
