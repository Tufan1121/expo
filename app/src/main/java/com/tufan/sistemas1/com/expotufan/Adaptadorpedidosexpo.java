...
public class Adaptadorpedidosexpo extends BaseAdapter{
...
//precio lista
    ...
    public Adaptadorpedidosexpo(Context contexto, ArrayList<String>endatospedido, ArrayList<String>endatosfecha, ArrayList<String>endatosnombre, ArrayList<String>endatostotalcompra) {
