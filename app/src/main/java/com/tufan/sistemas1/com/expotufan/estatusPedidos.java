...
public class estatusPedidos extends AppCompatActivity implements View.OnClickListener {
...
Button botoneditpedidos2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botoneditpedidos2.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case  R.id.btn_modificarpedidoxd:
                //TODO... Modificacion de pedidos Bodegas
                Intent pasaamodificarpedido= new Intent(this,ver_pedidos_hechos_modificar.class);
                startActivity(pasaamodificarpedido);
                break;
            case  R.id.btn_modificarpedidoxd2:
                //TODO... Modificacion de pedidos Expo
                 Intent pasaamodificarpedido2= new Intent(this,ver_pedidos_hechos_modificarE.class);
                startActivity(pasaamodificarpedido2);
                break;
            default:
                break;
