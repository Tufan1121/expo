...
public class Adaptador_x_nombreexpo extends BaseAdapter{
...
//precio lista
    ...
    public Adaptador_x_nombreexpo(Context contexto, ArrayList<String> datos, ArrayList<String> datosdes, ArrayList<String> datospmedida, ArrayList<String> datospstok, ArrayList<String>datosimg, ArrayList<String>datosdiseno, ArrayList<String>datosprecio1, ArrayList<String>datosprecio2, ArrayList<String>datosprecio3) {
