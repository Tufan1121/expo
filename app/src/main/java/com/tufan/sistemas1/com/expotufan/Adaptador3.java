...
//precio lista
    ...
    public Adaptador3(Context contexto, ArrayList<String> datos, ArrayList<String> datosdes, ArrayList<String> datospl, ArrayList<String> datospe, ArrayList<String> datospm, ArrayList<String>datosmedida,ArrayList<String>datosporciento) {
