...
public class entrega_estatus_pedido_anticipo extends AppCompatActivity implements View.OnClickListener {
    Button pedidobuscar;
    Button salirpedidos;
    ...
    String GET = appRutaservidor.IP  + "/obtener_pedidos_allanticipo.php";
    String GET_BY_ID = appRutaservidor.IP  + "/obtener_pedido_idpanticipo.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_entrega_estatus_pedido_anticipo);
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s =="No hay alumnos"){
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(entrega_estatus_pedido_anticipo.this, android.R.layout.simple_list_item_1,listItems);
                ...
                listatodoslospedidos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        //VER PEDIDO CON PDF*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
                        Intent pasaaverdetalledepedido = new Intent(entrega_estatus_pedido_anticipo.this,pedidoestatusanticipo.class);
