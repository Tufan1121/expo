...
//precio lista
    ...
    public Adaptador(Context contexto, ArrayList<String> datos,ArrayList<String> datosdes,ArrayList<String> datospl,ArrayList<String> datospe,ArrayList<String> datospm, ArrayList<String>datosmedida,ArrayList<String>datosporciento) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Button botonmas = vista.findViewById(R.id.mas);
        ...
        final TextView porciento= vista.findViewById(R.id.txt_porciento);
