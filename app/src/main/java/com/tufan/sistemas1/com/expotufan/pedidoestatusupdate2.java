...
public class pedidoestatusupdate2 extends AppCompatActivity {
    String pedidoavtivo;
    String idpedido;
    ...
    String UPDATEinventario = appRutaservidor.IP  + "/spock.php";
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                SwipeListViewTouchListener touchListener = new SwipeListViewTouchListener(listatapetesPedido, new SwipeListViewTouchListener.OnSwipeCallback() {
                    ...
                    public void onSwipeLeft(ListView listView, int[] reverseSortedPositions) {
                        ...
                        if (cc>1) {
                            Toast.makeText(pedidoestatusupdate2.this,"son mas de dos piesas ",Toast.LENGTH_LONG).show();
                ...
                //Toast.makeText(pedidoestatusupdate2.this,"nuemro de arrar liz"+listItems.size(),Toast.LENGTH_SHORT).show();
                int total=0;
                int multi=0;
                ...
                Toast.makeText(pedidoestatusupdate2.this,"lo que costo todo ...."+total,Toast.LENGTH_SHORT).show();
