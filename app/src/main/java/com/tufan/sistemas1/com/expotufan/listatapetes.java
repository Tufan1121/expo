...
public class listatapetes extends AppCompatActivity{
TextView txtpasa;
private Button escanerclaves;
private Button hacerpedido;
private ListView mlista;
private EditText clavemanual;
...
private  int total=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listatapetes);
        ...
        if(listaConta.clavetapete==null){
            ...
            mlista.setAdapter(new Adaptador(listatapetes.this,listaConta.clavetapete,listaConta.descripciontapete,listaConta.precioXtapete,listaConta.precioXtapeteEx,listaConta.precioXtapeteMa,listaConta.medidastapete,listaConta.porciento));
...
*/
        ...
        //Toast.makeText(this,"esto es lo que paso=="+xx,Toast.LENGTH_LONG).show();
        ...
        clavemanual.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
                ...
                if(clavemanual.toString().trim().equalsIgnoreCase("")){
                    Toast.makeText(listatapetes.this,"Coloca Clave ",Toast.LENGTH_LONG).show();
                    clavemanual.setFocusable(true);
                }else{
                    int checarlista=arrayList.size();
                    String claveconsulta=clavemanual.getText().toString();
                    validastock.checartapete(claveconsulta);

                    if (validastock.error404==0){
                        Toast.makeText(listatapetes.this, "No esta se encuantra en tu inventario",Toast.LENGTH_LONG).show();
                    }else{

                        //Toast.makeText(listatapetes.this,"cuantas tengo que quitar "+validastock.cuantaspiesastengovalida,Toast.LENGTH_LONG).show();
                        int stoksss=Integer.parseInt(validastock.stockspropreciovalida);
                        // Toast.makeText(listatapetes.this,"cuantas tengo "+stoksss,Toast.LENGTH_LONG).show();

                        int validarsihay=stoksss-validastock.cuantaspiesastengovalida;

                        if(validarsihay<=0){
                            Toast.makeText(listatapetes.this,"No tienes existencias... ",Toast.LENGTH_LONG).show();
                            ...
                            if(checarlista==0){
                                ...
                                if (x==1){
                                    ...
                                    Toast.makeText(listatapetes.this,"ya esta en tu lista... indica cuantas requieres",Toast.LENGTH_LONG).show();
        ...
        hacerpedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(listaConta.clavetapete.size()==0){
                    Toast.makeText(listatapetes.this,"no hay tapetes",Toast.LENGTH_LONG).show();

                }else {
                    Intent intent = new Intent(listatapetes.this, generaPedido.class);
...
//******************************************************************************************************Toast.makeText(this,"resultado "+result.getContents(),Toast.LENGTH_LONG).show();
                ...
                if(claveconsulta.length()<18){
                    ...
                    validastock.checartapetelg(claveconsulta);
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s=="No"){
                Toast.makeText(listatapetes.this,"no se escuentra en expo",Toast.LENGTH_LONG).show();
