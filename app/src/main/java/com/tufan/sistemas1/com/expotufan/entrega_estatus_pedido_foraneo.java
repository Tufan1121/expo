...
public class entrega_estatus_pedido_foraneo extends AppCompatActivity implements View.OnClickListener {
    Button pedidobuscar;
    Button salirpedidos;
    ...
    String GET = appRutaservidor.IP  + "/obtener_pedidos_all_foraneo.php";
            ...
            if(s.toString()=="No hay alumnos"){
                ...
                listatodoslospedidos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        //VER PEDIDO CON PDF*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
                        Intent pasaaverdetalledepedido = new Intent(entrega_estatus_pedido_foraneo.this,pedidoestatusforaneo.class);
