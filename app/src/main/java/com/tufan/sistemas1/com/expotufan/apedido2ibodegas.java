...
public class apedido2ibodegas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_pedido2ibodegas);
        ...
        _buscar= findViewById(R.id.buscarep);
...
*/
        ...
        _buscar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                hiloconexion2 = new apedido2ibodegas.ObtenerWebService();
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s=="No"){
                ...
                hiloconexion2like = new apedido2ibodegas.ObtenerWebService2();
                ...
                lista_x_tapete.setAdapter(new Adaptador_x_nombreIbodegas(apedido2ibodegas.this,listaxclave,listaxnombre,listaxmedidas,listaxstok,listaximg,listadiseno,listabodega1,listabodega2,listabodega3,listabodega4,xlistaprecio1,xlistaprecio2,xlistaprecio3));


                lista_x_tapete.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Toast.makeText(apedido2ibodegas.this,"estas es la clave "+listaxclave.get(position),Toast.LENGTH_SHORT).show();
                        listatapetes2.clavemanual.setText(listaxclave.get(position));
    ...
    public class ObtenerWebService2 extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s=="No"){
                ...
                hiloconexion3like = new apedido2ibodegas.ObtenerWebService3();
