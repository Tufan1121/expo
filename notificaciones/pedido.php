...
$sql = "SELECT * FROM pedido INNER JOIN expo WHERE expo.idexpo=pedido.idexpo and pedido.pedidos = '$aid' LIMIT 1";
...
function FancyTable($header, $data,$data2,$data3,$data4,$data5,$data6)
{
	...
	global $anticipo3;
		...
		$this->Cell($w[5],6,"$".number_format($total,2),'LR',0,'R',$fill);
        $this->Ln();
        $fill = !$fill;
		$this->Cell($w[0],6,"",'LR',0,'L',$fill);
...
//$filePDf='C:/stuff/dt2/MAMP/htdocs/notificaciones/pedidos/'.$aid.'.PDF';
//$pdf->Output($filePDf,'S');
//****************************************************************************************************************************************************
?>